...
import {
  CheckCircle2, Loader2, ShieldCheck, Zap, Lock, Crown,
  Medal, Award, CircleDot, Trophy, Gem, Shield, Diamond, Heart, Hexagon, Castle, Star,
  type LucideIcon,
} from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              ...
              border: `1px solid ${pkg.color}${future ? "33" : "66"}`,
              boxShadow: future ? "none" : `0 0 18px -4px ${pkg.color}80, inset 0 1px 0 rgba(255,255,255,0.12)`,
          ...
          <span
            ...
            style={{ color: future ? "rgba(255,255,255,0.6)" : "#fff" }}
          >
            {pkg.headline}
          </span>
        </div>

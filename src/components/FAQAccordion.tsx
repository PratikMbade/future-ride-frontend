...
const FAQS = [
  ...
  { q: 'How are rewards distributed?', a: 'Rewards split automatically: 20% Direct Income (instant referral), 50% Upgrade Income (team upgrades), 20% Level Income, and 5% Daily Royalty Income. Zero human involvement — purely smart contract driven.' },
